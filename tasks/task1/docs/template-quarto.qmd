---
title: |
  <img src="https://github.com/Transparencia-Brasil/transparencia.org.br/blob/master/webroot/favicon.png?raw=true" width="40" alt="Favicon Transparência Brasil">
  Inserir título
...
format:
  html:
    ...
    other-links:
      ...
      #   icon: file-bar-graph
      #   href: https://transparencia-brasil.github.io/r-template-tb/
      - text: Repositório no GitHub
        icon: github
        href: https://github.com/Transparencia-Brasil/ # adicionar repositório
    toc-float: false
    toc-collapsed: false
